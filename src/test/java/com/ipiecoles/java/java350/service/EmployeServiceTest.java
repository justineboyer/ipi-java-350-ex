...
class EmployeServiceTest {
    ...
    //principe du mock est de prendre une dépendance qui est dans l'algo et de le remplacer par quelque chose qu'on maitrise
    //Ne pas oublier de metre les extentions @Mock et @InjectMock
    //Tests avec mock
    ...
    @Test
    public void embaucheEmployeTechnicienPleinTempsBts() throws EmployeException {
    ...
    /**
     * Denier matricule pour un employe : 00345
